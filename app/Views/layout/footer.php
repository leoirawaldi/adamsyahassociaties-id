...
<!-- ======= Footer ======= -->
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Adamsyah Associaties</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
  ...
  <a href="https://api.whatsapp.com/send/?phone=6285767487917&text=Halo%2C+saya+ingin+bertanya+mengenai+Adamsyah+%26+Associaties.&type=phone_number&app_absent=0" class="back-to-top d-flex align-items-center justify-content-center"><i class="bi bi-whatsapp"></i></a>
